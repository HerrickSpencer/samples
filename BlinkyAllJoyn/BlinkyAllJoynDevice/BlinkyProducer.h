...
extern PCSTR c_BlinkyIntrospectionXml;

ref class BlinkyProducer;

public interface class IBlinkyProducer
{
    event Windows::Foundation::TypedEventHandler<BlinkyProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    event Windows::Foundation::TypedEventHandler<BlinkyProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<BlinkyProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<BlinkyProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class BlinkyProducer sealed : [Windows::Foundation::Metadata::Default] IBlinkyProducer
{
public:
    BlinkyProducer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~BlinkyProducer();

    // The implementation of IBlinkyService that will handle method calls and property requests.
    property IBlinkyService^ Service
    {
        IBlinkyService^ get() { return m_serviceInterface; }
        void set(IBlinkyService^ value) { m_serviceInterface = value; }
    }
    ...
    virtual event Windows::Foundation::TypedEventHandler<BlinkyProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    
    // This event will fire whenever the producer loses the session that it created.
    virtual event Windows::Foundation::TypedEventHandler<BlinkyProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    
    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<BlinkyProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<BlinkyProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;

    // Send a signal to all members of the session to notify them that the value of BlinkInterval has changed.
    void EmitBlinkIntervalChanged();

    // Send a signal to all members of the session to notify them that the value of IsBlinking has changed.
    void EmitIsBlinkingChanged();
...
private:
    ...
    IBlinkyService^ m_serviceInterface;
