...
public interface class IBlinkyConsumer
{
    event Windows::Foundation::TypedEventHandler<BlinkyConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<BlinkyConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<BlinkyConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
    event Windows::Foundation::TypedEventHandler<BlinkyConsumer^, Platform::Object^>^ BlinkIntervalChanged;
    event Windows::Foundation::TypedEventHandler<BlinkyConsumer^, Platform::Object^>^ IsBlinkingChanged;
};

public ref class BlinkyConsumer sealed  : [Windows::Foundation::Metadata::Default] IBlinkyConsumer
{
public:
    BlinkyConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~BlinkyConsumer();
    ...
    static Windows::Foundation::IAsyncOperation<BlinkyJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ BlinkyWatcher^ watcher);

    // Call the Start method
    Windows::Foundation::IAsyncOperation<BlinkyStartResult^>^ StartAsync();
    // Call the Stop method
    Windows::Foundation::IAsyncOperation<BlinkyStopResult^>^ StopAsync();
    // Get the value of the Version property.
    Windows::Foundation::IAsyncOperation<BlinkyGetVersionResult^>^ GetVersionAsync();

    // This event fires whenever the value of BlinkInterval changes.
    virtual event Windows::Foundation::TypedEventHandler<BlinkyConsumer^, Platform::Object^>^ BlinkIntervalChanged;
    
    // Get the value of the BlinkInterval property.
    Windows::Foundation::IAsyncOperation<BlinkyGetBlinkIntervalResult^>^ GetBlinkIntervalAsync();

    // Set the value of the BlinkInterval property.
    Windows::Foundation::IAsyncOperation<BlinkySetBlinkIntervalResult^>^ SetBlinkIntervalAsync(_In_ double value);
    // This event fires whenever the value of IsBlinking changes.
    virtual event Windows::Foundation::TypedEventHandler<BlinkyConsumer^, Platform::Object^>^ IsBlinkingChanged;
    
    // Get the value of the IsBlinking property.
    Windows::Foundation::IAsyncOperation<BlinkyGetIsBlinkingResult^>^ GetIsBlinkingAsync();


    // Used to send signals or register functions to handle received signals.
    property BlinkySignals^ Signals
    {
        BlinkySignals^ get() { return m_signals; }
    }

    // This event will fire whenever the consumer loses the session that it is a member of.
    virtual event Windows::Foundation::TypedEventHandler<BlinkyConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<BlinkyConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<BlinkyConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
